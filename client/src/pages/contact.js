  ...
  <div className="row container">
    <div className="col s12 m6">
      <div className="section white">
        <div className="row">
          <div className="col s12 m6">
            <img className="employees" src="https://images.unsplash.com/photo-1618568949779-895d81686151?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D&auto=format&fit=crop&w=1742&q=80"></img>
          </div>
          <div className="col s12 m6 employees_text">
            <h4>John Doe</h4>
            <p>IT Expert</p>
            <p>Tlf: 12 34 56 78</p>
            <p>Email: JohnDoe@BookIT.com</p>
          </div>
        </div>
      </div>
    </div>
